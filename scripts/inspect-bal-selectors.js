...
async function inspectLoginPage() {
  ...
  try {
    ...
    if (emailInputs.length > 0) {
      ...
      console.log('Detalles:', JSON.stringify(emailInputs[0], null, 2));
    }
    
    console.log('\nPassword inputs encontrados:', passwordInputs.length);
    if (passwordInputs.length > 0) {
      console.log('Password input selector:', passwordInputs[0].selector);
      console.log('Detalles:', JSON.stringify(passwordInputs[0], null, 2));
    }
    ...
    console.log('📸 Screenshot guardada en: screenshots/ui/bal-login-inspect.png');
